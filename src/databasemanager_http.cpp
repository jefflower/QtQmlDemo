                                       ...
                                       const QString &username, const QString &password)
{
    ...
    request.setUrl(QUrl("http://localhost:8000/test"));
...
QList<VisitRecord> DatabaseManager::queryVisitsByDate(const QDate &date)
{
    ...
    QNetworkAccessManager manager;
    QNetworkRequest request;
    request.setUrl(QUrl("http://localhost:8000/query_visits_by_date"));
    request.setHeader(QNetworkRequest::ContentTypeHeader, "application/json");
...
bool DatabaseManager::updateVisitSSGroupCode(int visitId, const QString &groupCode)
{
    QNetworkAccessManager manager;
    QNetworkRequest request;
    request.setUrl(QUrl("http://localhost:8000/update_visit_group_code"));
    request.setHeader(QNetworkRequest::ContentTypeHeader, "application/json");
